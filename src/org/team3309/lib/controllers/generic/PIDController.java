...
public abstract class PIDController extends Controller {
    ...
    /**
     * @param completable whether the loop can end execution
     */
    ...
    /**
     * @param tIME_TO_BE_COMPLETE_MILLISECONDS time
     */
    ...
    public void sendToSmartDash() {
        ...
        SmartDashboard.putNumber(" kI", kI);
        SmartDashboard.putNumber(" kD", kD);
        SmartDashboard.putNumber(" ERROR", this.previousError);
    }
